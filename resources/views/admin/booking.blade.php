    ...
    <div class="container-fluid">
      ...
      @endif
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                 <form class="form-control mr-5" method="post" action="viewBooking">
                     @csrf
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="form-control infoformmodal mt-2" method="POST" action="movetoSales">
                                        @csrf
                                            <h2 class="d-flex justify-content-center">Discoutn (If exist)</h2>
                                            <div class="form-group mt-3">
                                                <input type="text" class="form-control bg-light" name="extra" placeholder="Extra(Cold Drinks, Water)" id="discount" min="0">
                                            </div>
                                            <div class="form-group mt-3">
                                                <input type="text" class="form-control bg-light" name="discount" placeholder="Discount" id="discount" min="0">
                                            </div>
                                            <div class="form-group">       
                                                <input type="text" id="gettingGround" name="book_id" hidden>
                                            </div>
                                            <div class="form-group">
